...
impl ComposerKeyBindings {
    fn from_values(values: &HashMap<String, String>) -> Result<Self, String> {
        ...
        let bindings = Self {
            ...
            archive: binding(COMPOSER_ARCHIVE_KEY_SETTING, "a")?,
            change_set_actions: binding(COMPOSER_CHANGE_SET_ACTIONS_KEY_SETTING, ".")?,
            delete_change_set: binding(COMPOSER_DELETE_CHANGE_SET_KEY_SETTING, "x")?,
            rename_change_set: binding(COMPOSER_RENAME_CHANGE_SET_KEY_SETTING, "r")?,
            clone_change_set: binding(COMPOSER_CLONE_CHANGE_SET_KEY_SETTING, "c")?,
